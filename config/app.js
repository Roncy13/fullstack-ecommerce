...
module.exports = {
  ...
  */
  ...
  /*
  |--------------------------------------------------------------------------
  | Set Time Cache Item to Expire
  |--------------------------------------------------------------------------
  |
  | Currently, we are setting the EXPIRATION to 1 day, depending on the time retrieval
  |
  */
  EXPIRATION: 1440,
  ...
  |--------------------------------------------------------------------------
  |
  | This are the following API KEY ERRORS of TURING
  |
  */
  ...
  ERROR_CODES: {
    ...
    */
    ...
    PROD_01: "Don'exist Product with this ID.",
